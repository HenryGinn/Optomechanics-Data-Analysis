...
class Detuning():
    ...
    fitting_choice_functions = {"1": (self.update_fitting_parameter, 0),
    ...
    def set_gamma(self):
        ...
        self.fitting_parameters = self.get_automatic_fit(initial_fitting_parameters)
    ...
    def get_initial_fitting_parameters(self):
        ...
        noise, w = mean(self.S21[:end])/20, 2
    ...
    def get_automatic_fit(self, initial_fitting_parameters):
        fitting_parameters = leastsq(self.get_residuals,
    ...
    fit_ratio = self.fitting_parameters[:2]/self.initial_fitting_parameters[:2]
    fit_heuristic = sum(fit_ratio + 1/fit_ratio) + abs(self.fitting_parameters[3] - self.initial_fitting_parameters[3])
    if fit_heuristic > 20:
    ...
    def fit_plot_manually_iteration(self):
        ...
        fitting_choice_functions = self.get_fitting_choice_functions()
    ...
    def execute_manual_fit_choice(self, fitting_input_choice):
        if fitting_input_choice in fitting_choice_functions:
    ...
    def update_fitting_parameter(self, parameter_index):
        ...
        try:
            ...
            fitting_parameters[parameter_index] = new_parameter_value
        except:
    ...
    def reattempt_automatic_fit(self):
        self.get_automatic_fit(self.fitting_parameters)
        continue_looping = True
        fit_rejected = None
        return continue_looping, fit_rejected
    ...
    def plot_S21(self, fitting=None):
        plt.figure()
    ...
    def plot_fitting(self, fitting):
        if fitting is not None:
            plt.plot(self.frequency_offset,
                     self.evaluation_lorentzian(fitting),

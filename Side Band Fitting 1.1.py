...
class DataSet():
    ...
    def set_power_folder_path_data(self):
        ...
        elif self.folder_structure_type == 2:
...
class Power():
    ...
    Organising the processing of the detunings and plotting things happens here.
    """
...
class Detuning():
    ...
    """
    This class handles all the data for one detuning.
...
For data sets in the same format as 16112022, use folder_structure_type=2
"""
